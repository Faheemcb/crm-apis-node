...
import nationalIdRouter from "./NationalIdLabel/Router.js"
...
const options = {
    ...
    apis: [
        ...
        path.join(__dirname, "NationalIdLabel", "Router.js")
...
// Defining routes
app.use('/api/v1', subscriberrouter, userrouter, countryRouter, stateRouter, districtRouter, cityRouter, nationalIdRouter)
